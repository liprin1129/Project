...
%%%%%%%%%%%%%%%%%%%
% Piecewise powerlaw가 임의적으로 구간이 나눠져서 제대로 curve를 보기 어렵다? 
% 논문을 더 읽어보기!
%%%%%%%%%%%%%%%%%%%
...
\textbf{Hash table}, %https://youtu.be/h2d9b_nEzoA
\textbf{cut 15 attempts}.
%'eventAction', 'eventLabel', 'date', 'hour', 'minute',
%       'latitude', 'longitude', 'eventValue', 'play_filter', 'comb_time',
%       'diff_time', 'localtime', 'long_gap', 'shor_gap', 'sleepgap', 'gaptype',
%       'total_plays'
...
%The algorithm it was used for the analysis is K-Means clustering.
...
\begin{figure}[thpb] \label{fig:Competitive_Diagram}
	...
	\framebox{\parbox{12cm}{ 
	    \begin{center}
	        \includegraphics[width=10cm]{Competitive_Diagram.png} 
	    \end{center}}}
	\end{center}
...
\begin{figure}[thpb] \label{fig:not_norm_data}
    ...
    \framebox{\parbox{14cm}{
        \begin{center}
            \includegraphics[width=6.5cm]{not_norm_data.png}
            \includegraphics[width=6.5cm]{not_norm_weight.png}
        \end{center} }}
...
\begin{figure}[thpb] \label{fig:dead_unit}
	...
	\framebox{\parbox{12cm}{ 
	    \begin{center}
	    \includegraphics[width = 12cm]{dead_unit.png} 
	    \end{center}}}
...
\bibitem{Shafranovich 2008} Shafranovich, Y. (2008). Common Format and MIME Type for Comma-Separated Values (CSV) Files.[Sl], 2005. \emph{Disponıvel em:$<$ http://www. ietf. org/rfc/rfc4180. txt.}
