...
The term of overfitting in machine learning is the case that "a model is too complex and is using its surplus complexity to fit to noise" \cite{rogers2015first}
\textbf{Definition}\\
\textbf{AIC, BIC}
