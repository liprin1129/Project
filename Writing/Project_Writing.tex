...
\begin{split}
   \mathbf{M}= \left[\begin{array}{lll}
        ...
        101	&	151	&	201\\
        151	&	201	&	251\\
        w_3 + w_5 x_n^{w_4} &\quad \textrm{if $x_n >$ transition point} & b\end{array} \right].
\end{split}
\end{equation}
Because a start point of the first piece does not change, all elements in the first row are 1. 
...
For this, a matrix which will save costs of each piece is introduced
...
\subsection{Choice of Breaking Point}
\subsection{Number of Break Points}
